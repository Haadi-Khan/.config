...
#+begin_src emacs-lisp :tangle config.el
(defun my/colemak-mode-toggle ()
  "Enable or disable Colemak-DH rebinds."
  (if colemak-mode
      (progn
        (message "Colemak mode enabled")
        (evil-define-key 'normal colemak-mode-map
    ...
    (message "Colemak mode disabled"))))

(define-minor-mode colemak-mode
  "Mode to enable Colemak-DH rebinds"
  :lighter " ColemakMode"
  :keymap (let ((map (make-sparse-keymap)))
            (my/colemak-mode-toggle)
            map)
  (my/colemak-mode-toggle))
