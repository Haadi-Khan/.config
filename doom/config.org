...
#+end_src
** Colemak
I've been learning colemak-dh, so I want to create toggle-able minor mode so I can learn how to use it with emacs effectively
#+begin_src emacs-lisp :tangle config.el
;; Define the minor mode
(define-minor-mode colemak-mode
  "Mode to enable Colemak-DH rebinds"
  :lighter " ColemakMode"
  :keymap (let ((map (make-sparse-keymap)))
            ...
            ;; Replace state bindings
            (evil-define-key 'replace map
              (kbd "C-e") (kbd "C-k"))

            map))

;; Define a global version of the minor mode
(define-globalized-minor-mode global-colemak-mode colemak-mode
  (lambda ()
    (colemak-mode 1)))

(global-colemak-mode 1)

(defun colemak-elfeed-bindings ()
  "Set Colemak bindings for elfeed-search-mode."
  (evil-define-key 'normal elfeed-search-mode-map
    "n" 'evil-next-line
    "e" 'evil-previous-line))

(add-hook 'colemak-mode-hook
          (lambda ()
            (if colemak-mode
                (colemak-elfeed-bindings)
              (progn
                ;; Unset the bindings when disabling Colemak mode
                (evil-define-key 'normal elfeed-search-mode-map
                  "n" nil
                  "e" nil)))))
