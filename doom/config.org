...
(let ((bg (face-attribute 'default :background)))
    (custom-set-faces
     ...
     `(company-tooltip-common ((t (:background ,(color-lighten-name bg 10)) )))
     `(company-tooltip-annotation ((t (:background ,(color-lighten-name bg 0)) )))
     `(company-tooltip-quick-access ((t (:background ,(color-lighten-name bg 0)) )))
))
#+end_src
** Corfu
#+begin_src emacs-lisp :tangle config.el
